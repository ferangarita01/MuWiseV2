// src/app/api/email-unified/route.ts
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Store signer invitation using unified database client
    // Note: This would need to be implemented in the database adapter
    // For now, we'll use a simplified approach
    console.log('Storing signer invitation:', { agreementId, token, email });
